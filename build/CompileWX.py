...
def CreatePropsFile(path, platformDir, useStatic):
	...
	print(r'    <wxIntRootDir>$(wxCompilerPrefix)$(wxArchSuffix)_$(wxToolkitPrefix)u$(wxSuffixDebug)dll\</wxIntRootDir>', file=output)
	print(r'  </PropertyGroup>', file=output)
	...
	print(r'    <wxIntRootDir>$(wxCompilerPrefix)$(wxArchSuffix)_$(wxToolkitPrefix)u$(wxSuffixDebug)\</wxIntRootDir>', file=output)
	print(r'  </PropertyGroup>', file=output)
