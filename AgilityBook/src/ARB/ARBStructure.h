...
#define ATTRIB_TITLE_POINTS_TYPE			wxT("Type")
#define ATTRIB_TITLE_POINTS_TYPE_NORMAL			wxT("Norm")
#define ATTRIB_TITLE_POINTS_TYPE_T2B			wxT("T2B")
#define ATTRIB_TITLE_POINTS_TYPE_UKI			wxT("UKI")
