...
ARBDogRunScoring::ScoringType ARBDogRunScoring::GetType() const
{
	return m_type;
}

void ARBDogRunScoring::SetType(
...
double ARBDogRunScoring::GetSCT() const
{
	return m_SCT;
}

void ARBDogRunScoring::SetSCT(double inSCT)
{
	m_SCT = inSCT;
}

double ARBDogRunScoring::GetSCT2() const
{
	return m_SCT2;
}

void ARBDogRunScoring::SetSCT2(double inSCT)
{
	m_SCT2 = inSCT;
}

double ARBDogRunScoring::GetYards() const
{
	return m_Yards;
}

void ARBDogRunScoring::SetYards(double inYards)
{
	m_Yards = inYards;
}

double ARBDogRunScoring::GetTime() const
{
	return m_Time;
}

void ARBDogRunScoring::SetTime(double inTime)
{
	m_Time = inTime;
}

bool ARBDogRunScoring::HasTable() const
{
	return m_Table;
}

void ARBDogRunScoring::SetHasTable(bool inInc)
{
	m_Table = inInc;
	m_ConvertTable = false;
}

bool ARBDogRunScoring::TableNeedsConverting() const
{
	return m_ConvertTable;
}

short ARBDogRunScoring::GetCourseFaults() const
{
	return m_CourseFaults;
}

void ARBDogRunScoring::SetCourseFaults(short inFaults)
{
	m_CourseFaults = inFaults;
}

short ARBDogRunScoring::GetNeedOpenPts() const
{
	return m_NeedOpenPts;
}

void ARBDogRunScoring::SetNeedOpenPts(short inOpenPts)
{
	m_NeedOpenPts = inOpenPts;
}

short ARBDogRunScoring::GetNeedClosePts() const
{
	return m_NeedClosePts;
}

void ARBDogRunScoring::SetNeedClosePts(short inClosePts)
{
	m_NeedClosePts = inClosePts;
}

short ARBDogRunScoring::GetOpenPts() const
{
	return m_OpenPts;
}

void ARBDogRunScoring::SetOpenPts(short inOpenPts)
{
	m_OpenPts = inOpenPts;
}

short ARBDogRunScoring::GetClosePts() const
{
	return m_ClosePts;
}

void ARBDogRunScoring::SetClosePts(short inClosePts)
{
	m_ClosePts = inClosePts;
}

short ARBDogRunScoring::GetBonusPts() const
{
	return m_BonusPts;
}

void ARBDogRunScoring::SetBonusPts(short inBonusPts)
{
