...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "../.." /I "../../Include" /I "../../ARB" /I "../../Win" /I "../../../../boost" /I "$(WXWIN)/include" /I "$(WXWIN)/include/msvc" /D "WXWIDGETS" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_WINDLL" /Yu"stdafx.h" /FD /GZ /c
# SUBTRACT CPP /Fr
...
# ADD LINK32 ws2_32.lib comctl32.lib rpcrt4.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /debug /machine:I386 /pdbtype:sept /libpath:"../../../lib/VC6" /libpath:"$(WXWIN)\lib\vc_lib_VC60"
...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "../.." /I "../../Include" /I "../../ARB" /I "../../Win" /I "../../../../boost" /I "$(WXWIN)/include" /I "$(WXWIN)/include/msvc" /D "WXWIDGETS" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_WINDLL" /Yu"stdafx.h" /FD /c
# SUBTRACT CPP /Fr
...
# ADD LINK32 ws2_32.lib comctl32.lib rpcrt4.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /machine:I386 /libpath:"../../../lib/VC6" /libpath:"$(WXWIN)\lib\vc_lib_VC60"
