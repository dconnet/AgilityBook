...
void CDlgDogPanelReportBase::DoCreate(bool isSingleSel, bool hasImageList)
{
	...
	m_ctrlList->Bind(wxEVT_COMMAND_LIST_ITEM_FOCUSED, &CDlgDogPanelReportBase::OnItemFocused, this);
	m_ctrlList->Bind(wxEVT_DESTROY, [this](wxWindowDestroyEvent& evt) {
		m_ctrlList->Unbind(wxEVT_COMMAND_LIST_ITEM_FOCUSED, &CDlgDogPanelReportBase::OnItemFocused, this);
	});
	// End TODO
