	...
	, m_ExistingPoints()
{
	...
	m_ctrlTitles->Bind(wxEVT_KEY_DOWN, &CDlgDog::OnTitleKeyDown, this);
	...
	m_ctrlRegNums->Bind(wxEVT_KEY_DOWN, &CDlgDog::OnRegNumKeyDown, this);
	...
	m_ctrlPoints->Bind(wxEVT_KEY_DOWN, &CDlgDog::OnPointsKeyDown, this);
