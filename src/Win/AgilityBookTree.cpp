...
BEGIN_MESSAGE_MAP(CAgilityBookTree, CTreeView)
	...
	ON_UPDATE_COMMAND_UI(ID_AGILITY_PRINT_TRIAL, OnUpdateDogCmd)
	ON_COMMAND_EX(ID_AGILITY_PRINT_TRIAL, OnDogCmd)
	ON_UPDATE_COMMAND_UI(ID_AGILITY_PRINT_RUNS, OnUpdateDogCmd)
	ON_COMMAND_EX(ID_AGILITY_PRINT_RUNS, OnDogCmd)
