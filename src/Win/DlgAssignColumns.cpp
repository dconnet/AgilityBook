...
} const sc_FieldNames[IO_MAX] =
{
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_REG_NAME,
		true, LVCFMT_LEFT, IDS_COL_REG_NAME, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_CALL_NAME,
		true, LVCFMT_LEFT, IDS_COL_CALLNAME, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_DATE,
		true, LVCFMT_LEFT, IDS_COL_DATE, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_VENUE,
		true, LVCFMT_LEFT, IDS_COL_VENUE, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_CLUB,
		true, LVCFMT_LEFT, IDS_COL_CLUB, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_LOCATION,
		true, LVCFMT_LEFT, IDS_COL_LOCATION, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_TRIAL_NOTES,
		true, LVCFMT_LEFT, IDS_COL_TRIALNOTES, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_DIVISION,
		true, LVCFMT_LEFT, IDS_COL_DIVISION, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_LEVEL,
		true, LVCFMT_LEFT, IDS_COL_LEVEL, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_EVENT,
		true, LVCFMT_LEFT, IDS_COL_EVENT, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_HEIGHT,
		true, LVCFMT_LEFT, IDS_COL_HEIGHT, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_JUDGE,
		true, LVCFMT_LEFT, IDS_COL_JUDGE, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_HANDLER,
		true, LVCFMT_LEFT, IDS_COL_HANDLER, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_CONDITIONS,
		true, LVCFMT_LEFT, IDS_COL_CONDITIONS, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_COURSE_FAULTS,
		true, LVCFMT_RIGHT, IDS_COL_COURSEFAULTS, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_TIME,
		true, LVCFMT_RIGHT, IDS_COL_TIME, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_YARDS,
		true, LVCFMT_RIGHT, IDS_COL_YARDS, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_YPS,
		false, LVCFMT_RIGHT, IDS_COL_YPS, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_SCT,
		true, LVCFMT_RIGHT, IDS_COL_SCT, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_TOTAL_FAULTS,
		false, LVCFMT_RIGHT, IDS_COL_TOTAL_FAULTS, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_REQ_OPENING,
		true, LVCFMT_RIGHT, IDS_COL_REQ_OPENING, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_REQ_CLOSING,
		true, LVCFMT_RIGHT, IDS_COL_REQ_CLOSING, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_OPENING,
		true, LVCFMT_RIGHT, IDS_COL_OPENING, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_CLOSING,
		true, LVCFMT_RIGHT, IDS_COL_CLOSING, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_REQ_POINTS,
		true, LVCFMT_RIGHT, IDS_COL_REQ_POINTS, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_POINTS,
		true, LVCFMT_RIGHT, IDS_COL_POINTS, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_PLACE,
		true, LVCFMT_CENTER, IDS_COL_PLACE, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_IN_CLASS,
		true, LVCFMT_CENTER, IDS_COL_IN_CLASS, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_DOGSQD,
		true, LVCFMT_CENTER, IDS_COL_Q_D, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_Q,
		true, LVCFMT_CENTER, IDS_COL_Q, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_SCORE,
		false, LVCFMT_RIGHT, IDS_COL_SCORE, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_TITLE_POINTS,
		false, LVCFMT_RIGHT, IDS_COL_TITLE_PTS, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_COMMENTS,
		true, LVCFMT_LEFT, IDS_COL_COMMENTS, NULL},
	{CAgilityBookOptions::eRunsImport | CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_FAULTS,
		true, LVCFMT_LEFT, IDS_COL_FAULTS, NULL},

	{CAgilityBookOptions::eCalImport | CAgilityBookOptions::eCalExport | CAgilityBookOptions::eViewCal,
		IO_CAL_START_DATE,
		true, LVCFMT_LEFT, IDS_COL_START_DATE, NULL},
	{CAgilityBookOptions::eCalImport | CAgilityBookOptions::eCalExport | CAgilityBookOptions::eViewCal,
		IO_CAL_END_DATE,
		true, LVCFMT_LEFT, IDS_COL_END_DATE, NULL},
	{CAgilityBookOptions::eCalImport | CAgilityBookOptions::eCalExport,
		IO_CAL_TENTATIVE,
		true, 0, IDS_COL_TENTATIVE, NULL},
	{CAgilityBookOptions::eCalImport | CAgilityBookOptions::eCalExport,
		IO_CAL_ENTERED,
		true, 0, IDS_COL_ENTERED, NULL},
	{CAgilityBookOptions::eCalImport | CAgilityBookOptions::eCalExport | CAgilityBookOptions::eViewCal,
		IO_CAL_LOCATION,
		true, LVCFMT_LEFT, IDS_COL_LOCATION, NULL},
	{CAgilityBookOptions::eCalImport | CAgilityBookOptions::eCalExport | CAgilityBookOptions::eViewCal,
	...
	{CAgilityBookOptions::eCalImport | CAgilityBookOptions::eCalExport | CAgilityBookOptions::eViewCal,
		IO_CAL_OPENS,
		true, LVCFMT_LEFT, IDS_COL_OPENS, NULL},
	{CAgilityBookOptions::eCalImport | CAgilityBookOptions::eCalExport | CAgilityBookOptions::eViewCal,
		IO_CAL_CLOSES,
		true, LVCFMT_LEFT, IDS_COL_CLOSES, NULL},
	{CAgilityBookOptions::eCalImport | CAgilityBookOptions::eCalExport | CAgilityBookOptions::eViewCal,
		IO_CAL_NOTES,
		true, LVCFMT_LEFT, IDS_COL_NOTES, NULL},
	...
	{CAgilityBookOptions::eLogImport | CAgilityBookOptions::eLogExport | CAgilityBookOptions::eViewLog,
		IO_LOG_NAME,
		true, LVCFMT_LEFT, IDS_COL_NAME, NULL},
	{CAgilityBookOptions::eLogImport | CAgilityBookOptions::eLogExport | CAgilityBookOptions::eViewLog,
		IO_LOG_NOTES,
		true, LVCFMT_LEFT, IDS_COL_NOTES, NULL},
	...
	{CAgilityBookOptions::eViewTree,
		IO_TREE_DOG_REGNAME,
		false, 0, IDS_COL_REG_NAME, NULL},
	{CAgilityBookOptions::eViewTree,
		IO_TREE_DOG_CALLNAME,
		false, 0, IDS_COL_CALLNAME, NULL},
	{CAgilityBookOptions::eViewTree,
		IO_TREE_DOG_BREED,
		false, 0, IDS_COL_BREED, NULL},
	{CAgilityBookOptions::eViewTree,
		IO_TREE_DOG_DOB,
		false, 0, IDS_COL_DOB, NULL},
	{CAgilityBookOptions::eViewTree,
		IO_TREE_DOG_AGE,
		false, 0, IDS_COL_AGE, NULL},

	{CAgilityBookOptions::eViewTree,
		IO_TREE_TRIAL_START,
		false, 0, IDS_COL_START_DATE, NULL},
	{CAgilityBookOptions::eViewTree,
		IO_TREE_TRIAL_END,
		false, 0, IDS_COL_END_DATE, NULL},
	{CAgilityBookOptions::eViewTree,
		IO_TREE_TRIAL_CLUB,
		false, 0, IDS_COL_CLUB, NULL},
	{CAgilityBookOptions::eViewTree,
		IO_TREE_TRIAL_VENUE,
		false, 0, IDS_COL_VENUE, NULL},
	{CAgilityBookOptions::eViewTree,
		IO_TREE_TRIAL_LOCATION,
		false, 0, IDS_COL_LOCATION, NULL},
	{CAgilityBookOptions::eViewTree,
		IO_TREE_TRIAL_NOTES,
		false, 0, IDS_COL_NOTES, NULL},

	{CAgilityBookOptions::eViewTree,
		IO_TREE_RUN_DATE,
		false, 0, IDS_COL_DATE, NULL},
	{CAgilityBookOptions::eViewTree,
		IO_TREE_RUN_Q,
		false, 0, IDS_COL_Q, NULL},
	{CAgilityBookOptions::eViewTree,
		IO_TREE_RUN_EVENT,
		false, 0, IDS_COL_EVENT, NULL},
	{CAgilityBookOptions::eViewTree,
		IO_TREE_RUN_DIVISION,
		false, 0, IDS_COL_DIVISION, NULL},
	{CAgilityBookOptions::eViewTree,
		IO_TREE_RUN_LEVEL,
		false, 0, IDS_COL_LEVEL, NULL},
	{CAgilityBookOptions::eViewTree,
		IO_TREE_RUN_HEIGHT,
		false, 0, IDS_COL_HEIGHT, NULL},

	{CAgilityBookOptions::eLogImport | CAgilityBookOptions::eLogExport | CAgilityBookOptions::eViewLog,
		IO_LOG_SUBNAME,
		true, LVCFMT_LEFT, IDS_COL_SUBNAME, NULL},
	{CAgilityBookOptions::eViewTree,
		IO_TREE_TRIAL_VERIFIED,
		false, 0, IDS_COL_VERIFIED, NULL},
	{CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_SPEED,
		false, LVCFMT_LEFT, IDS_COL_SPEED, NULL},

	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_SUBJECT,
		false, 0, IDS_COL_SUBJECT, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_START_DATE,
		false, 0, IDS_COL_START_DATE, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_START_TIME,
		false, 0, IDS_COL_START_TIME, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_END_DATE,
		false, 0, IDS_COL_END_DATE, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_END_TIME,
		false, 0, IDS_COL_END_TIME, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_ALLDAY,
		false, 0, IDS_COL_ALL_DAY_EVENT, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_REMINDER,
		false, 0, IDS_COL_REMINDER, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_REMINDER_DATE,
		false, 0, IDS_COL_REMINDER_DATE, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_REMINDER_TIME,
		false, 0, IDS_COL_REMINDER_TIME, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_ORGANIZER,
		false, 0, IDS_COL_ORGANIZER, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_REQ_ATTENDEES,
		false, 0, IDS_COL_REQ_ATTENDEES, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_OPT_ATTENDEES,
		false, 0, IDS_COL_OPT_ATTENDEES, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_RESOURCES,
		false, 0, IDS_COL_RESOURCES, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_BILLING,
		false, 0, IDS_COL_BILLING, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_CATEGORIES,
		false, 0, IDS_COL_CATEGORIES, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_DESCRIPTION,
		false, 0, IDS_COL_DESCRIPTION, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_LOCATION,
		false, 0, IDS_COL_LOCATION, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_MILEAGE,
		false, 0, IDS_COL_MILEAGE, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_PRIORITY,
		false, 0, IDS_COL_PRIORITY, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_PRIVATE,
		false, 0, IDS_COL_PRIVATE, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_SENSITIVITY,
		false, 0, IDS_COL_SENSITIVITY, NULL},
	{CAgilityBookOptions::eCalExportAppt,
		IO_CAL_APPT_SHOW_TIME_AS,
		false, 0, IDS_COL_SHOW_TIME_AS, NULL},
	...
	{CAgilityBookOptions::eCalExportTask,
		...
		false, 0, IDS_COL_COMPLETED_DATE, NULL},
	{CAgilityBookOptions::eCalExportTask,
		IO_CAL_TASK_COMPLETE,
		false, 0, IDS_COL_COMPLETE, NULL},
	{CAgilityBookOptions::eCalExportTask,
		IO_CAL_TASK_TOTAL_WORK,
		false, 0, IDS_COL_TOTAL_WORK, NULL},
	{CAgilityBookOptions::eCalExportTask,
		IO_CAL_TASK_ACTUAL_WORK,
		false, 0, IDS_COL_ACTUAL_WORK, NULL},
	{CAgilityBookOptions::eCalExportTask,
		IO_CAL_TASK_BILLING,
		false, 0, IDS_COL_BILLING, NULL},
	{CAgilityBookOptions::eCalExportTask,
	...
	{CAgilityBookOptions::eCalExportTask,
		...
		false, 0, IDS_COL_COMPANIES, NULL},
	{CAgilityBookOptions::eCalExportTask,
		IO_CAL_TASK_CONTACTS,
		false, 0, IDS_COL_CONTACTS, NULL},
	{CAgilityBookOptions::eCalExportTask,
		IO_CAL_TASK_MILEAGE,
		false, 0, IDS_COL_MILEAGE, NULL},
	{CAgilityBookOptions::eCalExportTask,
	...
	{CAgilityBookOptions::eCalExportTask,
		IO_CAL_TASK_ROLE,
		false, 0, IDS_COL_ROLE, NULL},
	{CAgilityBookOptions::eCalExportTask,
		IO_CAL_TASK_SCH_PRIORITY,
		false, 0, IDS_COL_SCH_PRIORITY, NULL},
	{CAgilityBookOptions::eCalExportTask,
		IO_CAL_TASK_SENSITIVITY,
		false, 0, IDS_COL_SENSITIVITY, NULL},
	{CAgilityBookOptions::eCalExportTask,
		IO_CAL_TASK_STATUS,
		false, 0, IDS_COL_STATUS, NULL},

	{CAgilityBookOptions::eRunsExport | CAgilityBookOptions::eViewRuns,
		IO_RUNS_MIN_YPS,
		false, LVCFMT_RIGHT, IDS_COL_MIN_YPS, NULL},
};
