...
{
	{L"ID_NEW",                     wxID_NEW,                    true, false, false, 'N'},
	{L"ID_OPEN",                    wxID_OPEN,                   true, false, false, 'O'},
	{L"ID_SAVE",                    wxID_SAVE,                   true, false, false, 'S'},
	{L"ID_SAVEAS",                  wxID_SAVEAS,                false, false, false, WXK_F12},
	{L"ID_FILE_LANGUAGE_CHOOSE",    ID_FILE_LANGUAGE_CHOOSE,    false, false, false, 0},
	{L"ID_FILE_EXPORT_WIZARD",      ID_FILE_EXPORT_WIZARD,       true, false, false, 'E'},
	{L"ID_FILE_LINKED",             ID_FILE_LINKED,             false, false, false, 0},
	{L"ID_PRINT",                   wxID_PRINT,                  true, false, false, 'P'},
	{L"ID_FILE_PRINT_BLANK_RUNS",   ID_FILE_PRINT_BLANK_RUNS,   false, false, false, 0},
	{L"ID_PREVIEW",                 wxID_PREVIEW,                true,  true, false, 'P'},
	{L"ID_FILE_PROPERTIES",         ID_FILE_PROPERTIES,         false, false, false, 0},
	{L"ID_EXIT",                    wxID_EXIT,                  false, false, false, 0},
	{L"ID_CUT",                     wxID_CUT,                    true, false, false, 'X'},
	{L"ID_COPY",                    wxID_COPY,                   true, false, false, 'C'},
	{L"ID_PASTE",                   wxID_PASTE,                  true, false, false, 'V'},
	{L"ID_DUPLICATE",               wxID_DUPLICATE,             false, false, false, 0},
	{L"ID_DELETE",                  wxID_DELETE,                false, false, false, WXK_DELETE},
	{L"ID_SELECTALL",               wxID_SELECTALL,              true, false, false, 'A'},
	{L"ID_COPY_TITLES_LIST",        ID_COPY_TITLES_LIST,        false, false, false, 0},
	{L"ID_REORDER",                 ID_REORDER,                 false, false, false, 0},
	{L"ID_FIND",                    wxID_FIND,                   true, false, false, 'F'},
	{L"ID_EDIT_FIND_NEXT",          ID_EDIT_FIND_NEXT,          false, false, false, WXK_F3},
	{L"ID_EDIT_FIND_PREVIOUS",      ID_EDIT_FIND_PREVIOUS,      false, false,  true, WXK_F3},
	{L"ID_EDIT_CONFIGURATION",      ID_EDIT_CONFIGURATION,      false, false, false, 0},
	{L"ID_AGILITY_EDIT_DOG",        ID_AGILITY_EDIT_DOG,        false, false, false, 0},
	{L"ID_AGILITY_NEW_DOG",         ID_AGILITY_NEW_DOG,         false, false, false, 0},
	{L"ID_AGILITY_DELETE_DOG",      ID_AGILITY_DELETE_DOG,      false, false, false, 0},
	{L"ID_AGILITY_EDIT_TITLE",      ID_AGILITY_EDIT_TITLE,      false, false, false, 0},
	{L"ID_AGILITY_NEW_TITLE",       ID_AGILITY_NEW_TITLE,       false, false, false, 0},
	{L"ID_AGILITY_DELETE_TITLE",    ID_AGILITY_DELETE_TITLE,    false, false, false, 0},
	{L"ID_AGILITY_EDIT_TRIAL",      ID_AGILITY_EDIT_TRIAL,      false, false, false, 0},
	{L"ID_AGILITY_NEW_TRIAL",       ID_AGILITY_NEW_TRIAL,       false, false, false, 0},
	{L"ID_AGILITY_DELETE_TRIAL",    ID_AGILITY_DELETE_TRIAL,    false, false, false, 0},
	{L"ID_AGILITY_PRINT_TRIAL",     ID_AGILITY_PRINT_TRIAL,     false, false, false, 0},
	{L"ID_AGILITY_EDIT_RUN",        ID_AGILITY_EDIT_RUN,        false, false, false, 0},
	{L"ID_AGILITY_NEW_RUN",         ID_AGILITY_NEW_RUN,          true, false, false, 'R'},
	{L"ID_AGILITY_DELETE_RUN",      ID_AGILITY_DELETE_RUN,      false, false, false, 0},
	{L"ID_AGILITY_PRINT_RUNS",      ID_AGILITY_PRINT_RUNS,      false, false, false, 0},
	{L"ID_AGILITY_EDIT_CALENDAR",   ID_AGILITY_EDIT_CALENDAR,   false, false, false, 0},
	{L"ID_AGILITY_NEW_CALENDAR",    ID_AGILITY_NEW_CALENDAR,    false, false, false, 0},
	{L"ID_AGILITY_DELETE_CALENDAR", ID_AGILITY_DELETE_CALENDAR, false, false, false, 0},
	{L"ID_AGILITY_UPDATE_CALENDAR", ID_AGILITY_UPDATE_CALENDAR, false, false, false, 0},
	{L"ID_AGILITY_EXPORT_CALENDAR", ID_AGILITY_EXPORT_CALENDAR, false, false, false, 0},
	{L"ID_AGILITY_CREATEENTRY_CALENDAR", ID_AGILITY_CREATEENTRY_CALENDAR, false, false, false, 0},
	{L"ID_AGILITY_EDIT_TRAINING",   ID_AGILITY_EDIT_TRAINING,   false, false, false, 0},
	{L"ID_AGILITY_NEW_TRAINING",    ID_AGILITY_NEW_TRAINING,    false, false, false, 0},
	{L"ID_AGILITY_DELETE_TRAINING", ID_AGILITY_DELETE_TRAINING, false, false, false, 0},
	{L"ID_NOTES_CLUBS",             ID_NOTES_CLUBS,             false, false, false, 0},
	{L"ID_NOTES_JUDGES",            ID_NOTES_JUDGES,             true, false, false, 'J'},
	{L"ID_NOTES_LOCATIONS",         ID_NOTES_LOCATIONS,         false, false, false, 0},
	{L"ID_NOTES_SEARCH",            ID_NOTES_SEARCH,            false, false, false, 0},
	{L"ID_PREFERENCES",             wxID_PREFERENCES,           false, false, false, WXK_F7},
	{L"ID_VIEW_CUSTOMIZE",          ID_VIEW_CUSTOMIZE,          false, false, false, 0},
	{L"ID_UNSORT",                  ID_UNSORT,                  false, false, false, 0},
	{L"ID_VIEW_SORTRUNS",           ID_VIEW_SORTRUNS,           false, false, false, 0},
	{L"ID_VIEW_RUNS_BY_TRIAL",      ID_VIEW_RUNS_BY_TRIAL,      false, false, false, 0},
	{L"ID_VIEW_TABLE_IN_YPS",       ID_VIEW_TABLE_IN_YPS,       false, false, false, 0},
	{L"ID_VIEW_RUNTIME_IN_OPS",     ID_VIEW_RUNTIME_IN_OPS,     false, false, false, 0},
	{L"ID_VIEW_POINTS_VIEW_SORT",   ID_VIEW_POINTS_VIEW_SORT,   false, false, false, 0},
	{L"ID_VIEW_HIDDEN",             ID_VIEW_HIDDEN,             false, false, false, 0},
	{L"ID_VIEW_LIFETIME_EVENTS",    ID_VIEW_LIFETIME_EVENTS,    false, false, false, 0},
	{L"ID_EXPAND",                  ID_EXPAND,                  false, false, false, 0},
	{L"ID_COLLAPSE",                ID_COLLAPSE,                false, false, false, 0},
	{L"ID_EXPAND_ALL",              ID_EXPAND_ALL,              false, false, false, 0},
	{L"ID_COLLAPSE_ALL",            ID_COLLAPSE_ALL,            false, false, false, 0},
#if wxUSE_NOTEBOOK
	{L"ID_BOOK_NOTEBOOK",           ID_BOOK_NOTEBOOK,            true, false, false, '1'},
#endif
#if wxUSE_LISTBOOK
	{L"ID_BOOK_LISTBOOK",           ID_BOOK_LISTBOOK,            true, false, false, '2'},
#endif
#if wxUSE_CHOICEBOOK
	{L"ID_BOOK_CHOICEBOOK",         ID_BOOK_CHOICEBOOK,          true, false, false, '3'},
#endif
#if wxUSE_TREEBOOK
	{L"ID_BOOK_TREEBOOK",           ID_BOOK_TREEBOOK,            true, false, false, '4'},
#endif
#if wxUSE_TOOLBOOK
	{L"ID_BOOK_TOOLBOOK",           ID_BOOK_TOOLBOOK,            true, false, false, '5'},
#endif
	{L"ID_ORIENT_TOP",              ID_ORIENT_TOP,              false, false, false, 0},
	{L"ID_ORIENT_BOTTOM",           ID_ORIENT_BOTTOM,           false, false, false, 0},
	{L"ID_ORIENT_LEFT",             ID_ORIENT_LEFT,             false, false, false, 0},
	{L"ID_ORIENT_RIGHT",            ID_ORIENT_RIGHT,            false, false, false, 0},
	{L"ID_WINDOW_SPLIT",            ID_WINDOW_SPLIT,            false, false, false, 0},
	{L"ID_NEXT_PANE",               ID_NEXT_PANE,               false, false, false, WXK_F6},
	{L"ID_PREV_PANE",               ID_PREV_PANE,               false, false,  true, WXK_F6},
	{L"ID_HELP_UPDATE",             ID_HELP_UPDATE,             false, false, false, 0},
	{L"ID_HELP_SYSINFO",            ID_HELP_SYSINFO,            false, false, false, 0},
	{L"ID_ABOUT",                   wxID_ABOUT,                 false, false, false, 0},
	{L"ID_DETAILS",                 ID_DETAILS,                 false, false, false, 0},
};
